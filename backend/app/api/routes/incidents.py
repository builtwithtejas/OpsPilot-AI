...
from app.services.gitlab_service import (
    # FIX: create_fix_mr_workflow does not exist in gitlab_service.py.
    # The real workflow is three separate functions: branch → commit → MR.
    create_fix_branch,
    commit_fix,
    create_fix_mr,
